 ...
 */
if ( !class_exists('WPB_ft_main_Settings_API' ) ):
class WPB_ft_main_Settings_API {

    private $settings_api;

    function __construct() {
        $this->settings_api = new WPB_ft_Settings_API;
    ...
    function admin_menu() {
        add_options_page( 'WPB FB Timeline', 'WPB FB Timeline', 'delete_posts', 'wpb_ftw', array($this, 'wpb_plugin_page') );
    }
	// setings tabs
...
$settings = new WPB_ft_main_Settings_API();